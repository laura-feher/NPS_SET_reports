...
summary_tbl <- function(slr_rate_comps_df, site_hydro_df, park_name, long_slr_rate_df) {
  ...
  slr_rate_comps_df %>%
    ...
    kable(booktabs = T, label = NA, escape = FALSE, align = "c",
          ...
          col.names = c("Site", "SEC rate (mm/yr)", "Marsh elevation (m NAVD88)", "MHW (m NAVD88)", "MSL (m NAVD88)", "Time flooded (%)", "Elevation capital", paste0("SEC vs. SLR-long", footnote_marker_number(1)), paste0("SEC vs. SLR-recent", footnote_marker_number(2)))) %>%
